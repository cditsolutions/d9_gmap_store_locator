/**
 * @file Contains the definition of the behaviour storeLocatorMap.
 */
    ...
    Drupal.behaviors.storeLocatorMap = {
        attach: function (context, settings) {
            ...
            map = new google.maps.Map(document.getElementById('map'),
                    mapOptions);
            map.setTilt(45);
            var infoWindow = new google.maps.InfoWindow(), key;
                                        ...
                                        .addListener(
                                                ...
                                                (function (gmarker, index) {
                                                    return function () {
                                                                        ...
                                                                        function (
                                                                            ...
                                                                            if (value != null && key !== 'latitude'
                                                                                ...
                                                                                if (key == 'website') {
                                                                                    ...
                                                                                    // content
                                                                                    // +='<span
                                                                                    // class="lbl">'+Drupal.t('Website')+':</span><div
                                                                                    // class="loc-'+key+'">'
                                                                                    // +
                                                                                    // web
                                                                                    // +
                                                        ...
                                                        var container = jQuery('#location-list-wrapper'), scrollTo = jQuery(
                                                                ".list-wrapper li")
                                                                .eq(index);
